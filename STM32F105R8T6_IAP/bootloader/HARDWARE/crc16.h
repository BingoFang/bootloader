...
/* crc16-modbus */
__inline unsigned short check_crc16(const unsigned char* snd,unsigned int len)
{
...
extern __inline unsigned short check_crc16(const unsigned char* snd,unsigned int len);
#endif /* _CRC16_H_ */
